...
require_once 'sendEmail.php'; // adjust path if needed
    ...
    <tr>
      <td class="hero-block" align="center" style="background:#1a1814;padding:52px 48px 48px;position:relative;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:32px;position:relative;z-index:1;">
          <tr><td align="center">
            <img src="https://enflow-ai.vercel.app/assets/logo.png" alt="EnflowAI" width="140" style="display:block;height:auto;max-height:48px;width:auto;max-width:140px;object-fit:contain;" />
          </td></tr>
        </table>
      ...
      <td class="body-block" style="background:#ffffff;padding:48px 48px 44px;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr><td style="background:#1a1814;border-radius:14px;padding:28px 30px;text-align:center;">
            <img src="https://enflow-ai.vercel.app/assets/logo.png" alt="" style="display:block;margin:0 auto 14px;width:150px;height:auto;opacity:0.6;" />
    ...
    <tr>
      <td class="footer-block" align="center" style="background:#f5f2ec;border-top:1px solid rgba(26,24,20,0.07);padding:32px 40px;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto 20px;">
          <tr><td align="center">
            <img src="https://enflow-ai.vercel.app/assets/icon.png" alt="EnflowAI" width="90" style="display:block;height:auto;max-height:30px;width:auto;max-width:90px;opacity:0.45;" />
          </td></tr>
        </table>
